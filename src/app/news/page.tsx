...
const TechNewsPage = () => {
  ...
  const videos = [
  {
    ...
    img: "/top10trends.jpg",
    url: "https://www.youtube.com/watch?v=YH4wP-ESLo4", // example video
  },
  {
    title: "Blockchain & AI: The Future",
    img: "/ai_blockchain_future.jpeg",
    url: "https://www.youtube.com/watch?v=UIXFYPzaFbY", // example video
  },
  {
    title: "Cybersecurity Trends You Must Know",
    img: "/cybersecuritytrend.png",
    url: "https://www.youtube.com/watch?v=kqaMIFEz15s", // example video
  },
];
...
<section className="relative w-full h-screen flex flex-col items-center text-white overflow-hidden">
  ...
  >
    Stay ahead with breaking stories, expert insights, and the latest innovations shaping the future of technology.
  </motion.p>
</section>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {magazines.map((mag, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <img src={mag.img} alt={mag.title} className="w-full h-56 object-cover" />
...
<section className="py-16 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
  <div className="container mx-auto px-6">
    <h2 className="text-4xl font-bold mb-10 text-center">Featured Videos</h2>
    <div className="grid md:grid-cols-3 gap-10">
      {videos.map((vid, i) => (
        <motion.div
          key={i}
          ...
          viewport={{ once: true }}
        >
          <img src={vid.img} alt={vid.title} className="w-full h-56 object-cover" />
          <div className="p-6 text-center">
