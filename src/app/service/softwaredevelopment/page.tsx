...
import { FaLaptopCode, FaCloud, FaShieldAlt, FaCogs, FaIndustry, FaGlobe } from "react-icons/fa";
...
<section className="relative h-[600px] flex items-center justify-center text-white overflow-hidden">
  ...
  >
    <source src="/servicesvideo\softwaredevelopmentvideo.mp4" type="video/mp4" />
  ...
  <div className="relative z-10 text-center px-6">
    ...
    <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
      Custom software solutions designed to accelerate digital transformation,
  ...
  <div className="grid md:grid-cols-2 gap-12 items-center">
    <div>
      ...
      <p className="text-gray-600 mb-4">
        At Prasunet, we craft scalable and innovative software tailored to your business needs.
        From enterprise applications to SaaS platforms, we ensure your business stays ahead.
      </p>
    ...
    <img src="/servicesimages/softwaredevelopmentimg1.jpg" alt="Software Development" className="rounded-2xl shadow-lg" />
  </div>
</section>
...
<section className="relative py-20 bg-gradient-to-r from-green-50 via-blue-50 to-green-100 overflow-hidden">
  ...
  <div className="container mx-auto px-6 text-center relative z-10">
    ...
    >
      Empowering businesses with next-gen technology solutions that combine innovation, scalability, and security.
    </motion.p>
    ...
    <div className="grid md:grid-cols-4 gap-8">
      {[
        ...
        >
          <div className="text-blue-700 mb-4 flex justify-center">{cap.icon}</div>
          <h3 className="font-semibold text-xl mb-3 text-gray-800">{cap.title}</h3>
    ...
    <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
      {[
        { 
          ...
          content: "We help financial institutions leverage technology for faster and secure transactions, analytics, and compliance."
        },
        { 
          name: "Healthcare", 
          img: "/servicesimages/helthcare.jpeg",
          content: "Transforming healthcare with digital solutions, telemedicine, patient data analytics, and efficient operations."
        },
        { 
          name: "Retail", 
          img: "/servicesimages/retail.jpeg",
          content: "Enhancing retail experiences through e-commerce platforms, AI-driven recommendations, and inventory management."
        },
        { 
          name: "Manufacturing", 
          img: "/servicesimages/manufacturing.jpeg", 
          content: "Optimizing production with automation, IoT solutions, and predictive maintenance strategies."
        },
      ].map((ind, idx) => (
        <motion.div
          key={idx}
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="flex flex-col space-y-12">
      {[
        ...
        <div key={idx} className="flex flex-col md:flex-row bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-transform transform hover:scale-105">
      ...
      {[
        ...
        >
          ...
          <div className="p-6 text-center flex flex-col justify-center">
            <h3 className="font-bold text-xl mb-2 text-blue-800">{model.title}</h3>
...
<section className="relative py-24">
  ...
  <div className="relative container mx-auto px-6 text-center text-white max-w-5xl">
    ...
    <p className="text-xl md:text-2xl mb-6 animate-slideUp">
      Prasunet proudly serves clients in <span className="text-blue-400 font-bold animate-pulse">65+ countries</span>, bridging continents with innovative technology solutions.
    </p>

    <p className="text-gray-200 text-lg md:text-xl mb-8 animate-slideUp delay-200">
      Our global footprint ensures local expertise, seamless collaboration, and faster project delivery. From AI-powered platforms to enterprise solutions, we empower businesses worldwide to achieve growth, efficiency, and digital transformation.
    </p>

    <p className="text-gray-300 text-base md:text-lg animate-slideUp delay-400">
      With strategically located hubs, a network of skilled professionals, and cutting-edge technology, Prasunet connects innovation with impact—no matter where your business is.
    </p>
  </div>
</section>
  ...
  <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
    ...
    <div className="md:w-1/2 text-center md:text-left">
      ...
      <p className="text-lg md:text-xl mb-8 text-gray-700 animate-slideUp delay-200">
        Partner with <span className="font-semibold text-blue-600">Prasunet</span> for innovative, scalable, and secure software solutions. Let's transform your ideas into reality with cutting-edge technology and a dedicated team.
      </p>
