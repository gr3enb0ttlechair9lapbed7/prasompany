...
import { FaChartLine, FaProjectDiagram, FaUserShield, FaBullseye, FaBalanceScale, FaNetworkWired } from "react-icons/fa";
  ...
  return (
    <div className="font-sans text-gray-900 bg-white">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        >
          <source src="/servicesvideo/itconsultingvideo.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-lg md:text-xl text-gray-200 max-w-xl mx-auto mb-6">
            Navigate digital complexity with clarity. We guide enterprises through technology transformation with data-driven strategy, architecture, and innovation.
          </p>
          <a
            href="/contact"
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <img src="/servicesimages/softwaredevelopmentimg1.jpg" alt="Consulting Strategy" className="rounded-xl shadow-xl" />
        <div>
          <h2 className="text-3xl font-bold mb-6 text-blue-900">Strategic IT Guidance for Future-Ready Enterprises</h2>
          <p className="text-gray-700 mb-5">
            At Prasunet, our IT consulting services help businesses align technology with long-term goals. Whether you're modernizing legacy systems or launching enterprise-wide transformation, we deliver clear roadmaps for success.
          </p>
      ...
      <section className="py-20 bg-gradient-to-br from-white to-blue-50 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-blue-900 mb-4">Consulting Capabilities</h2>
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
            Combining business acumen with technical expertise to design IT strategies that drive measurable growth and operational efficiency.
          </p>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">Expertise Across Key Industries</h2>
          <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
            We tailor IT consulting strategies to each sector, enabling innovation, efficiency, and growth at scale.
          </p>

          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { name: "Finance", img: "/servicesimages/finance.jpeg", text: "Resilient financial systems powered by secure, compliant IT architecture." },
              { name: "Healthcare", img: "/servicesimages/helthcare.jpeg", text: "Enabling digital health innovation through strategic technology planning." },
              { name: "Retail", img: "/servicesimages/retail.jpeg", text: "Optimized omnichannel IT for retail transformation and customer experience." },
              { name: "Manufacturing", img: "/servicesimages/manufacturing.jpeg", text: "Smart factory integration and IT modernization strategies." }
            ].map((ind, idx) => (
              <div
                key={idx}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12 text-blue-900">Impact-Driven Consulting Stories</h2>
            ...
            {[
              {
                ...
                bullets: ["Cloud strategy roadmap", "Risk mitigation plan", "Increased agility"]
              },
              {
                ...
                bullets: ["Workflow automation", "Improved patient experience", "Faster diagnostics"]
              },
              {
                ...
                bullets: ["ERP & CRM alignment", "Enhanced CX journey", "Integrated analytics"]
              }
            ].map((cs, idx) => (
      ...
      <section className="relative py-24">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center text-white z-10">
          ...
          <p className="text-xl mb-4">We deliver strategic technology advisory across 65+ countries with deep domain knowledge and cultural context.</p>
          <p className="text-gray-300">Global reach. Local impact. Future-proof consulting.</p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-blue-700 text-white text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-4">Ready to Rethink Your IT Strategy?</h2>
          <p className="text-lg mb-6">Connect with Prasunet's consultants to create powerful IT blueprints that drive transformation.</p>
